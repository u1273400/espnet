...
sender, to, subject, message_text, file = (
    ...
    'ESPNet Research: VF 250 feat 4 epochs',
    '',
...
CLIENT_SECRET_FILE = '/home/john/credentials.json'
API_NAME = 'gmail'
API_VERSION = 'v1'
SCOPES = ['https://mail.google.com/']
...
sender, to, subject, message_text, file = (
    'ESPNet Research',
    'john.alamina@hud.ac.uk',
    'ESPNet Research: CV 250 feat 200 epochs',
    '',
    [f'{root}results/{file}' for file in pngfiles]
)
...
if __name__ == '__main__':
    main()
>>>>>>> f3b11eb9c219ad0ed74f02a86f9f65c17deb4551:egs/commonvoice/asr0/local/elog3.py
